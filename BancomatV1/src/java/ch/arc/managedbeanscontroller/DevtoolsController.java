...
import ch.arc.ejbsessionfacade.DevtoolsFacade;
...
public class DevtoolsController implements Serializable {
    ...
    @EJB
    private ch.arc.ejbsessionfacade.DevtoolsFacade ejbFacade;
    ...
    public Devtools getDevtools(java.lang.Integer id) {
    ...
    public static class DevtoolsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDevtools(getKey(value));
        }
